...
DS_light_intensity_KEY = 'light_ppfd_umol_m2_s'
DS_light_spectrum_KEY = 'light_spectrum_nm_percent'
DS_plant_height_KEY = 'plant_height'
DS_leaf_count_KEY = 'leaf_count'
DS_horticulture_log_KEY = 'DailyHorticultureLog'
DS_runs_KEY = 'runs'
